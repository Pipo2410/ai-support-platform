          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-2 gap-4 md:grid-cols-4'>
              {INTEGRATIONS.map((integration) => (
                <button
                  className='flex items-center gap-4 border bg-background p-4 hover:bg-accent'
                  key={integration.id}
        ...
        <div className='space-y-6'>
          <div className='space-y-2'>
            ...
            <div className='group relative'>
              <pre className='max-h-[300px] overflow-x-auto overflow-y-auto whitespace-pre-wrap break-all rounded-md bg-foreground p-2 font-mono text-sm text-secondary'>
                {snippet}
              </pre>
              <Button
